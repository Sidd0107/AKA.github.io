(function($) {
    ...
    // default settings
    var defaults = {
        'animationType' : 'fadeIn', // @string: fade, no-effect, random, slide
        'autoslide'     : true,   // @bool
        ...
        if(_this.settings.autoslide) {
            ...
            _this.elem.find('div').click(function(){
                if ($(this).hasClass('paused')) {
                    $('<span class="playImg"></span>').appendTo(_this.elem).fadeIn(5000, function(){
                    ...
                    $('<span class="pauseImg"></span>').appendTo(_this.elem).fadeIn(5000, function(){
                        $(this).fadeOut(5000, function(){
                            $(this).remove()
                        });
                    });
    ...
    */
    ...
    var fadeEffect = function(active, toShow) {
        active.fadeOut(5000).removeClass('activeSlide');
        toShow.fadeIn(3000).addClass('activeSlide');
    };
